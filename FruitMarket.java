...
// Author      : Yajat Sharma
// Copyright   : None
// Description : This program is a little "slice of life" game like Animal Crossing, except the user has a nice, calm time ordering some fruits! 

// Revision History:
// Date              Version         Author             
// 09-24-22          1.0           Yajat Sharma       
// Once you run the program, it will show you the fruits that are available. Then you can choose which ones you want. Each runtime is an order, meaning that everything you order in each run adds up to your total. 
// When you choose a fruit, it will allow you to choose the weight and will show you the price per lb. It will then calculate your cost.
// You can end by clicking Q (or q).
//============================================================================
...
public class FruitMarket {
	public static void main(String[] args) {
		...
		market = new OnlineSuperMarket("EMERALD HACKS SUPER MARKET", "http://www.EmeraldHacksSupermarket.com" );
...
class OnlineSuperMarket{
	...
	public void init() {
		...
		double [] totalWeight = {16,      24,       0,       14,           55,     16,      27,      8.5,        19,            10};
